...
export CDP_BUILD_NUMBER=2506706
export CDP_MAVEN_REPOSITORY=\
"https://${IMPALA_TOOLCHAIN_HOST}/build/cdp_components/${CDP_BUILD_NUMBER}/maven"
export CDP_HADOOP_VERSION=3.1.1.7.1.1.0-374
export CDP_HBASE_VERSION=2.2.3.7.1.1.0-374
export CDP_HIVE_VERSION=3.1.3000.7.1.1.0-374
export CDP_RANGER_VERSION=2.0.0.7.1.1.0-374
export CDP_TEZ_VERSION=0.9.1.7.1.1.0-374
export CDP_KNOX_VERSION=1.3.0.7.1.1.0-374
export CDP_OZONE_VERSION=0.4.0.7.1.1.0-374
