...
import static org.apache.impala.catalog.metastore.CatalogHmsFileMetadataTest.assertFdsAreSame;
...
public class EnableCatalogdHmsCacheFlagTest {
  ...
  public static void setup() throws Exception {
    ...
    MetastoreConf.setVar(CONF, ConfVars.THRIFT_URIS, "thrift://localhost:5899");
