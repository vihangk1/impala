...
public class MetastoreEvents {
  ...
  public static class MetastoreEventFactory {
    ...
    private MetastoreEvent get(NotificationEvent event)
      ...
      switch (metastoreEventType) {
        case CREATE_TABLE:
          return new CreateTableEvent(catalog_, metrics_, event);
        case DROP_TABLE:
          return new DropTableEvent(catalog_, metrics_, event);
        case ALTER_TABLE:
          return new AlterTableEvent(catalog_, metrics_, event);
        case CREATE_DATABASE:
          return new CreateDatabaseEvent(catalog_, metrics_, event);
        case DROP_DATABASE:
          return new DropDatabaseEvent(catalog_, metrics_, event);
        case ALTER_DATABASE:
  ...
  public static class CreateTableEvent extends MetastoreTableEvent {
     ...
     */
    private CreateTableEvent(CatalogServiceCatalog catalog,
        Metrics metrics, NotificationEvent event)
        throws MetastoreNotificationException {
  ...
  public static class DropTableEvent extends MetastoreTableEvent {
     ...
     * Prevent instantiation from outside should use MetastoreEventFactory instead
     */
    private DropTableEvent(CatalogServiceCatalog catalog, Metrics metrics, NotificationEvent event)
        throws MetastoreNotificationException {
      super(catalog, metrics, event);
  ...
  public static class CreateDatabaseEvent extends MetastoreDatabaseEvent {
     ...
     * Prevent instantiation from outside should use MetastoreEventFactory instead
     */
    private CreateDatabaseEvent(CatalogServiceCatalog catalog, Metrics metrics, NotificationEvent event)
        throws MetastoreNotificationException {
      super(catalog, metrics, event);
  ...
  public static class DropDatabaseEvent extends MetastoreDatabaseEvent {
     ...
     * Prevent instantiation from outside should use MetastoreEventFactory instead
     */
    private DropDatabaseEvent(CatalogServiceCatalog catalog, Metrics metrics, NotificationEvent event) {
      super(catalog, metrics, event);
    }
  ...
  public static abstract class TableInvalidatingEvent extends MetastoreTableEvent {
     ...
     * Prevent instantiation from outside should use MetastoreEventFactory instead
     */
    private TableInvalidatingEvent(CatalogServiceCatalog catalog, Metrics metrics,
        NotificationEvent event) {
      super(catalog, metrics, event);
    }
  ...
  public static class AddPartitionEvent extends TableInvalidatingEvent {
     ...
     * Prevent instantiation from outside should use MetastoreEventFactory instead
     */
    private AddPartitionEvent(CatalogServiceCatalog catalog, Metrics metrics, NotificationEvent event)
        throws MetastoreNotificationException {
      super(catalog, metrics, event);
  ...
  public static class AlterPartitionEvent extends TableInvalidatingEvent {
     ...
     * Prevent instantiation from outside should use MetastoreEventFactory instead
     */
    private AlterPartitionEvent(CatalogServiceCatalog catalog, Metrics metrics, NotificationEvent event)
        throws MetastoreNotificationException {
      super(catalog, metrics, event);
  ...
  public static class DropPartitionEvent extends TableInvalidatingEvent {
     ...
     * Prevent instantiation from outside should use MetastoreEventFactory instead
     */
    private DropPartitionEvent(CatalogServiceCatalog catalog, Metrics metrics, NotificationEvent event) {
      super(catalog, metrics, event);
  ...
  public static class IgnoredEvent extends MetastoreEvent {
     ...
     * Prevent instantiation from outside should use MetastoreEventFactory instead
     */
    private IgnoredEvent(CatalogServiceCatalog catalog, Metrics metrics, NotificationEvent event) {
      super(catalog, metrics, event);
    }
