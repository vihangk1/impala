...
public class StringLiteral extends LiteralExpr {
  ...
  /**
   * TODO(Vihang) Copied from Hive's BaseSemanticAnalyzer. This method has not changed
   * since last several years so hoping that it is fairly stable by now. Source it from
   * the Hive's code without copying will require to add a unnecessary dependency to
   * hive-exec
   * @param b
   * @return
   */
